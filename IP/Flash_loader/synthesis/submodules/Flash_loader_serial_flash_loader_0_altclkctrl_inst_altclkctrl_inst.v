...
module  Flash_loader_serial_flash_loader_0_altclkctrl_inst_altclkctrl_inst_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //Flash_loader_serial_flash_loader_0_altclkctrl_inst_altclkctrl_inst_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  Flash_loader_serial_flash_loader_0_altclkctrl_inst_altclkctrl_inst  (
    ena,
    inclk,
    outclk);
...
`endif
    ...
    Flash_loader_serial_flash_loader_0_altclkctrl_inst_altclkctrl_inst_sub  Flash_loader_serial_flash_loader_0_altclkctrl_inst_altclkctrl_inst_sub_component (
                .ena (ena),
                .inclk (sub_wire2),
                .outclk (sub_wire0));
